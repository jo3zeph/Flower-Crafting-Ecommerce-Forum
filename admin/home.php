        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              ...
              ?>
               <a href="sales.php" class="small-box-footer"><p style="color:white">Sales History</p></a>
            </div>
            <div class="icon">
              <a href="sales.php" class="small-box-footer"><i class="fa fa-shopping-cart"></i></a>
            </div>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
             ...
             <a href="products.php" class="small-box-footer"> <p style="color:white">Number of Products</p></a>
            </div>
            <div class="icon">
               <a href="products.php" class="small-box-footer"><i class="fa fa-barcode"></i></a>
            </div>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              ...
              <a href="users.php" class="small-box-footer"><p style="color:white">Number of Users</p></a>
            </div>
            <div class="icon">
               <a href="users.php" class="small-box-footer"><i class="fa fa-users"></i></a>
            </div>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              ...
              <a href="sales.php" class="small-box-footer"><p style="color:white">Sales Today</p></a>
            </div>
            <div class="icon">
              <a href="sales.php" class="small-box-footer"><i class="fa fa-money"></i></a>
            </div>
            <a href="sales.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
